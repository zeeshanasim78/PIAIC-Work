...
let myAge: string | number; // Now methods that are valid for both will can be used
...
// It means age variable can either store a number or died or unkown string value
...
let zia: "zia"; // We have specified that only zia value can be assigned in the variable zia
