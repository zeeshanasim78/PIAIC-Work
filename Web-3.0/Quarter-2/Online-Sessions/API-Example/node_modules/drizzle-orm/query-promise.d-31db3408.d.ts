 ...
 */
declare const ne: BinaryOperator;
/**
 ...
 */
declare const gt: BinaryOperator;
/**
 * Test that the first expression passed is greater than
 ...
 */
declare const lt: BinaryOperator;
/**
 * Test that the first expression passed is less than
 ...
 */
declare const lte: BinaryOperator;
/**
...
declare function inArray<TColumn extends Column>(column: TColumn, values: (GetColumnData<TColumn, 'raw'> | Placeholder)[] | SQLWrapper): SQL;
declare function inArray<T extends SQLWrapper>(column: Exclude<T, SQL.Aliased | Column>, values: (unknown | Placeholder)[] | SQLWrapper): SQL;
/**
 * Test whether the first parameter, a column or expression,
 ...
 */
declare function like(column: Column, value: string | SQLWrapper): SQL;
/**
 ...
 */
declare function notLike(column: Column, value: string | SQLWrapper): SQL;
/**
 ...
 */
declare function ilike(column: Column, value: string | SQLWrapper): SQL;
/**
 ...
 */
declare function notIlike(column: Column, value: string | SQLWrapper): SQL;
...
type DBQueryConfig<TRelationType extends 'one' | 'many' = 'one' | 'many', TIsRoot extends boolean = boolean, TSchema extends TablesRelationalConfig = TablesRelationalConfig, TTableConfig extends TableRelationalConfig = TableRelationalConfig> = {
    ...
    orderBy?: ValueOrArray<AnyColumn | SQL> | ((fields: Simplify<[TTableConfig['columns']] extends [never] ? {} : TTableConfig['columns']>, operators: OrderByOperators) => ValueOrArray<AnyColumn | SQL>);
...
declare function createOne<TTableName extends string>(sourceTable: Table): <TForeignTable extends Table<TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
    tableName: TTableName;
}>, ...AnyColumn<{
    tableName: TTableName;
...
declare function createMany(sourceTable: Table): <TForeignTable extends Table<TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable, config?: {
    relationName: string;
...
declare function createTableRelationsHelpers<TTableName extends string>(sourceTable: AnyTable<{
    ...
    one: <TForeignTable extends Table<TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
        tableName: TTableName;
    }>, ...AnyColumn<{
        tableName: TTableName;
    }>[]]>(table: TForeignTable, config?: RelationConfig<TTableName, TForeignTable["_"]["name"], TColumns> | undefined) => One<TForeignTable["_"]["name"], Equal<TColumns[number]["_"]["notNull"], true>>;
    many: <TForeignTable_1 extends Table<TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable_1, config?: {
        relationName: string;
...
export { NormalizedRelation as $, TableRelationsKeysOnly as A, BinaryOperator as B, ExtractObjectValues as C, ExtractRelationsFromTableExtraConfigSchema as D, ExtractTableRelationsFromSchema as E, getOperators as F, Operators as G, getOrderByOperators as H, OrderByOperators as I, FindTableByDBName as J, DBQueryConfig as K, TableRelationalConfig as L, Many as M, ExtractTablesWithRelations as N, One as O, ReturnTypeOrValue as P, QueryPromise as Q, RelationalSchemaConfig as R, BuildRelationResult as S, TablesRelationalConfig as T, NonUndefinedKeysOnly as U, BuildQueryResult as V, RelationConfig as W, extractTablesRelationalConfig as X, relations as Y, createOne as Z, createMany as _, Relation as a, normalizeRelation as a0, createTableRelationsHelpers as a1, TableRelationsHelpers as a2, BuildRelationalQueryResult as a3, mapRelationalRow as a4, bindIfParam as b, and as c, not as d, eq as e, gte as f, gt as g, lte as h, inArray as i, notInArray as j, isNull as k, lt as l, isNotNull as m, ne as n, or as o, exists as p, notExists as q, between as r, notBetween as s, like as t, notLike as u, ilike as v, notIlike as w, asc as x, desc as y, Relations as z };
